$(document).ready(function () {
    ...
    $('#inputStatus').on('change', function () {
        if ($(this).val() === '') {
            $('#estado_actividad').DataTable().clear().draw();
        } else if ($(this).val() === 'En proceso') {
            read_all_actividades();
        } else if ($(this).val() === 'Finalizada') {
            read_all_actividades_i();
        }
    });
    async function read_all_actividades() {
        funcion = "read_all_actividades";
        let data = await fetch('../Controllers/estado_actividadesController.php', {
            method: 'POST',
    ...
    async function read_all_actividades_i() {
        funcion = "read_all_actividades_i";
        let data = await fetch('../Controllers/estado_actividadesController.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'funcion=' + funcion
